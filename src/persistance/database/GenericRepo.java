...
import persistance.connection.PGConnect;
...
public class GenericRepo<T> {
    ...
    public static <T> T save(T obj) throws SQLException, MismatchException {
        ...
        try {
            ...
            throw new SQLException("Erreur lors de l'insertion/la mise à jour de donnée :"+ e);
        }
    }
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(query);
            ...
            while (resultSet.next()) {
                ...
                for (Column column : columns) {
                    ...
                    String colBaseName = column.getNomColonneBase();
                    Field field = clazz.getDeclaredField(columnName);
                    field.setAccessible(true); 
                    Object value = DBUtil.getTransformedValue(resultSet, field, colBaseName);
                    field.set(obj, value);
                }
...
//    public static <T> List<T> findAllPaginate(Class<T> clazz, Pagination pagination) throws SQLException, MismatchException {
//        PGConnect pgConnect = PGConnect.getInstance();
//        Connection connection = pgConnect.getConnection();
//
//        String tableName = DBUtil.getTableName(clazz);
...
//    public static <T> int getTotalPages(Class<T> clazz, Pagination pagination) throws SQLException {
//        PGConnect pgConnect = PGConnect.getInstance();
//        Connection connection = pgConnect.getConnection();
//
//        String tableName = DBUtil.getTableName(clazz);
...
//            } else {
//                throw new SQLException("Impossible maka ny rows rehetra.");
//            }
//        }
//    }
//
    ...
    public static <T> List<T> findWCond(Class<T> clazz, String aWhere) throws SQLException, MismatchException {
        PGConnect pgConnect = PGConnect.getInstance();
        Connection connection = pgConnect.getConnection();
